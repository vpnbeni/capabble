          ...
          <label className="mt-4 block text-sm text-slate-300">
            ...
            <div className="relative mt-1.5">
              <input
                ...
                className="w-full rounded-lg border border-white/15 bg-slate-950/60 py-2.5 pl-3 pr-11 text-sm text-white outline-none ring-sky-500/40 placeholder:text-slate-500 focus:ring-2"
                value={password}
              ...
              <button
                ...
                className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-md p-1.5 text-slate-400 transition hover:bg-white/10 hover:text-slate-200"
